...
<body>
    ...
    <div class="container">
        <div id="mySidenav" class="side-nav side-nav-visible">
            ...
            <a href="#" id="pets" onclick="loadContent(this);"> <span class="fa fa-fw fa-paw"></span>Pets</a>
    ...
    <script>
        ...
        function loadContent(element) {
            ...
            switch( element.id ) {
                ...
                case "pets"             : viewAreaElement.setAttribute("data", "./app.php?service=showPetsAsTable");     break;
